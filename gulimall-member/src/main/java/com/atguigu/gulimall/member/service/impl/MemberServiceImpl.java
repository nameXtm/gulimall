...
//        bCryptPasswordEncoder.matches("","");
    ...
    public MemberEntity login(MemberUserLoginVo vo) {
        ...
        MemberEntity memberEntity = baseMapper1.selectOne(new QueryWrapper<MemberEntity>().eq("username", loginacct)
                .or().eq("mobile", loginacct));
        if (memberEntity==null){
            return null;
        }else {
            String passwordDp = memberEntity.getPassword();
            BCryptPasswordEncoder bCryptPasswordEncoder = new BCryptPasswordEncoder();
            boolean matches = bCryptPasswordEncoder.matches(password, passwordDp);
            if (matches){
                return memberEntity;
            }else {
                return null;
